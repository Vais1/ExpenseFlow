...
export default function HistoryPage() {
    ...
    // Filter to show only processed (non-pending) requests for history view?
    // Or show all. Generally "History" implies past actions. 
    // For now, let's show all but maybe sort by date? The backend already sorts by date desc.
